...
char* hv_get_last_message(HunterView hv);
location_t hv_get_dracula_possible(HunterView hv);
location_t hv_find_shortest_path (location_t start, location_t end,HunterView hv,int round, int playerNo);
